          ...
          <div className="flex-grow">
            ...
            <ul className="space-y-1 text-sm text-gray-800 mt-3 mb-4">
              ...
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '82%' }} />
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '70%' }} />
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '60%' }} />
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '44%' }} />
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '40%' }} />
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '30%' }} />
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '22%' }} />
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-100" aria-hidden="true" style={{ width: '12%' }} />
                <div className="relative flex justify-between space-x-2">
