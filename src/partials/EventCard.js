...
export default function EventCard({ eventId, itemId }) {
  return (
    <div
      id={eventId}
      className="bg-white shadow-md rounded-sm border border-gray-200 p-4 pt-2 mx-2 w-80 mb-4 select-none"
    >
      {/* Body */}
      <div className="mb-3">
        {/* Info */}
        ...
        <a className="font-light text-red-600 hover:underline" href="#0">
          09:30 am - 11:30 am
        </a>
      </div>
      ...
      <div className="mb-3 flex flex-row">
        ...
        <div className="ml-1">
          <span className="text-gray-800 hover:underline text-sm align-middle" href="#0">
            3/4 joined
          </span>
        </div>
      </div>
