  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
      ...
      <div className="flex items-center justify-between">
        {/* Left side */}
        <button type="button" className="p-2 flex-shrink-0 rounded-full bg-white border border-gray-200 hover:border-gray-300 text-indigo-500 transition duration-150">
        ...
        <div className="flex items-center">
          ...
          {/* Replies button */}
          <button type="button" className="flex items-center text-gray-400 hover:text-indigo-500 ml-3">
            <svg className="w-4 h-4 flex-shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
          ...
          {/* Attach button */}
          <button type="button" className="text-gray-400 hover:text-indigo-500 ml-3">
            <svg className="w-4 h-4 flex-shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
