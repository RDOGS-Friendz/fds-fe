  ...
  function DateRangePicker({
    ...
    return (
      <div className="relative">
        ...
        <Flatpickr className="form-input pl-9 text-gray-500 hover:text-gray-600 font-medium focus:border-gray-300 w-full md:w-72 uppercase" options={options} ref={ref} />
