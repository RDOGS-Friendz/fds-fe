  ...
  function DateRangePicker({
    ...
    return (
      <div className="relative">
        ...
        <Flatpickr className={`form-input pl-9 text-gray-500 hover:text-gray-600 font-medium focus:border-gray-300 uppercase ${inputClassName}`} options={options} ref={ref} />
