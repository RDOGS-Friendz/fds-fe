    ...
    <main>
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <AccordionBasic title="Filter/Advanced Search" initialState>
          <div className="grid grid-flow-col col-span-full gap-x-5 gap-y-5 mb-5">
            <div className="flex flex-row flex-wrap justify-between gap-x-0 gap-y-4 lg:gap-x-6">
              <div className="">
              ...
              <div className="">
                ...
                <DateRangePicker setValue={setDateRange} ref={dateRangePickerRef} inputClassName="w-70" />
              </div>
            </div>
          </div>
